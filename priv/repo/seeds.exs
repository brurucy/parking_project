...
[%{spot: "Vabriku 1", parking_fee_id: fee_a.id, places: 1, latitude: 58.37681, longitude: 26.70399},
%{spot: "Lossi 21", parking_fee_id: fee_b.id, places: 30, latitude: 58.37927, longitude: 26.71754},
%{spot: "Jakobi 2", parking_fee_id: fee_b.id, places: 50, latitude: 58.38237, longitude: 26.71489}]
|> Enum.map(fn parking_data -> Parking.changeset(%Parking{}, parking_data) end)
|> Enum.each(fn changeset -> Repo.insert!(changeset) end)


Booking.changeset(%Booking{}, %{destination: "Vabriku 1", duration: 50.0, distance: 50.0, status: "booked"})
|> Repo.insert()
